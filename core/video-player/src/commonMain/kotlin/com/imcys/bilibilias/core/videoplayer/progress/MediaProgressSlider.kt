...
class PlayerProgressSliderState(
    ...
    val displayPositionRatio by derivedStateOf {
        val previewPositionRatio = previewPositionRatio
    ...
    fun finishPreview() {
        val ratio = previewPositionRatio
...
object MediaProgressSliderDefaults {
    ...
    fun colors(
        ...
        cachedProgressColor: Color = MaterialTheme.colorScheme.onSurface,
        downloadingColor: Color = Color.Yellow,
        notAvailableColor: Color = MaterialTheme.colorScheme.error,
...
fun MediaProgressSlider(
    ...
    Box(
        ...
        var mousePosX by rememberSaveable { mutableFloatStateOf(0f) }
                    ...
                    awaitPointerEventScope {
                        while (true) {
                            ...
                            if (event.type == PointerEventType.Move) {
                                ...
                                mousePosX = event.changes.firstOrNull()?.position?.x
